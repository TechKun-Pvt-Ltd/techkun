...
import LegalBlocks from "@/app/components/LegalBlocks.tsx";
import {FULL_POLICY_BLOCKS, LAST_UPDATED, TOC_ITEMS} from "@/app/(site)/(legal)/privacy/content.ts";
        ...
        <section>
            <div className="legal-page pt-24 gap-16">
                <header className="legal-header">
                    <Link href="/privacy" className="legal-link type-body-sm mb-3" style={{display: "block"}}>← Back to Privacy Policy</Link>
                ...
                <div>
                    <nav aria-label="Detailed Privacy Policy contents" className="legal-toc mb-8 py-5 px-6">
                        <ul className="gap-y-2 gap-x-6">
                            {TOC_ITEMS.map(item => <li key={item.id} className="type-body-sm">
