...
const LINKEDIN_ICON_ID = "linked-in-icon";
const X_ICON_ID = "x-icon";
...
export const LINKEDIN_ICON_HREF = createHref(LINKEDIN_ICON_ID);
export const X_ICON_HREF = createHref(X_ICON_ID);
...
export default function Shared() {
    return <>
        ...
        >
            ...
            <symbol id={X_ICON_ID} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <title>X</title>
                <path
            ...
            <symbol id={LINKEDIN_ICON_ID} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
