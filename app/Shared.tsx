...
const TECHKUN_LOGO_PATH_ID = "techkun-logo-path";
const LINKEDIN_LOGO_PATH_ID = "linked-in-icon";
const X_LOGO_PATH_ID = "x-icon";
...
export const TECHKUN_LOGO_PATH_HREF = createHref(TECHKUN_LOGO_PATH_ID);
export const LINKEDIN_LOGO_PATH_HREF = createHref(LINKEDIN_LOGO_PATH_ID);
export const X_LOGO_PATH_HREF = createHref(X_LOGO_PATH_ID);
