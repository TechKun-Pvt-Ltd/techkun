...
export default function SocialCard() {
    return <div style={{ ...SOCIAL_CARD_SIZE, paddingBlock: "36px", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px", backgroundColor: "#030304" }}>
        <svg
            width={width} height={width * logoPath.viewBox.height / logoPath.viewBox.width}
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", color: "#dddee1" }}>
            <h1 style={{ margin: 0, letterSpacing: "0.06em", fontSize: "56px", marginBlockEnd: "0.2em" }}>TechKun</h1>
            <p style={{ margin: 0, fontSize: "24px", color: "#a2a9cb" }}>We build software with beauty,<br/>precision, and identity.</p>
        </div>
    </div>;
}