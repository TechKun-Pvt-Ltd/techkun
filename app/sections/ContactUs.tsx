...
export default function ContactUs() {
    return <section>
        ...
        <div css={css`overflow: hidden; margin-top: -30%; pointer-events: none;`}>
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="-2 -2 42 30" fill="none"
                 css={css`transform: translateY(30%);`}
            >
                ...
                {/*      stroke="var(--muted-foreground)" strokeWidth="0.03"*/}
                {/*      pathLength="10"*/}
                {/*      css={css`*/}
                {/*          stroke-dasharray: 5 5;*/}
                {/*          stroke-dashoffset: 10;*/}
                {/*          animation: strokeTravel 20s linear infinite;*/}
