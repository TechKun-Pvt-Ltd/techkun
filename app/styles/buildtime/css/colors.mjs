import {processConfig} from "../color-system-utils/css-palette-generation-utils.ts";
import {PALETTE_CUSTOMIZATION} from "../color-system-utils/css-palette-customization.ts";
